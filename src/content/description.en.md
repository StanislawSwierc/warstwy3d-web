...
The capacitance curve of bushing shows similar effect:
At first, with high resistance, the curve is flat in whole frequency range
With decreasing resistance, the C curve deforms to higher level, and is flat again, with broken layer, but at a higher capacity value 
So, when defect develops in the bushing core, you can obtain different tan-delta values, depending on the stadium of development.
